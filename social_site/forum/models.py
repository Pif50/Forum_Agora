...
from django.contrib.auth.models import User #Perché sono i nostri utenti a interagire con le discussioni
...
class Sezione(models.Model):
    ...
    Ciascuna sezione contiene svariate discussioni, create dagli aministratori del sito.
    '''
...
class Discussione(models.Model):
    ...
    def get_absolute_url(self): #Link per ottenere ogni singola istanza
