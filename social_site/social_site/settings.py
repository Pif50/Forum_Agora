...
SECRET_KEY = 'django-insecure-g$5%+g#iqs(3me&z)vqktzp36h8jh^k=ai4k!+67w4*$3&gpcr'
...
INSTALLED_APPS = [
    ...
    #App installate
    'accounts', #python manage.py startapp accounts. - Gestirà la registrazione degli utenti
    'core', #Gestirà homepage e funzione cerca
    'forum', #Gestirà la parte del forum vera e propria
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'social_site/templates',
